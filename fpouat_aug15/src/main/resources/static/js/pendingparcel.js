 ...
 var sitecode_name= $("#sitecode").val();
	...
	"processing": true,
		...
		"initComplete": function( settings ) {
	        $("#NotmappedSite_filter").append('<button type="button" class="btn btn-info" id="clear1" style="margin-left: 15px;margin-bottom: 5px;">Clear</button>');
		  $('#clear1').on('click', function() {
		    $('#NotmappedSite_filter input[type="search"]').val('').trigger('input');
				var table = $('#NotmappedSite').DataTable();
				table.search('').draw();
...
/* table 2*/
	...
	"processing": true,
		...
		"initComplete": function( settings ) {
	        $("#yettobemapSite_filter").append('<button type="button" class="btn btn-info" id="clear2" style="margin-left: 15px;margin-bottom: 5px;">Clear</button>');
...
/* table 3*/
	...
	"processing": true,
		...
		"initComplete": function( settings ) {
	        $("#maptospefcSite_filter").append('<button type="button" class="btn btn-info" id="clear3" style="margin-left: 15px;margin-bottom: 5px;">Clear</button>');
		  $('#clear3').on('click', function() {
		    $('#maptospefcSite_filter input[type="search"]').val('').trigger('input');
				var table = $('#maptospefcSite').DataTable();
				table.search('').draw();
