...
! function(a, b, c) {
            ...
            function(a, b, d) {
                TableTools = function(b, c) {
                    ...
                    return this.s = {
                        ...
                        return this.s
                    }, "undefined" == typeof c && (c = {}), this._fnConstruct(c), this
                    ...
                    "fnSelectAll": function(a) {
                        ...
                        this._fnRowSelect(a === !0 ? b.dt.aiDisplay : b.dt.aoData)
                    },
                    ...
                    "_fnButtonDefinations": function(b, c) {
                        for (var d, e = 0, f = b.length; f > e; e++) {
                            ...
                            c.appendChild(this._fnCreateButton(d, a(c).hasClass(this.classes.collection.container)))
                        }
                    },
                    "_fnCreateButton": function(a, b) {
                        var c = this._fnButtonBase(a, b);
                        return a.sAction.match(/flash/) ? this._fnFlashConfig(c, a) : "text" == a.sAction ? this._fnTextConfig(c, a) : "div" == a.sAction ? this._fnTextConfig(c, a) : "collection" == a.sAction && (this._fnTextConfig(c, a), this._fnCollectionConfig(c, a)), c
                    },
                    ...
                    "_fnGetDataTablesData": function(b) {
                        ...
                        var q = l.oInstance.$("tr", b.oSelectorOpts).map(function(b, c) {
                            return o && -1 === a.inArray(c, p) ? null : l.oInstance.fnGetPosition(c)
                        }).get();
                        for (e = 0, f = q.length; f > e; e++) {
                            for (i = l.aoData[q[e]].nTr, g = [], c = 0, d = l.aoColumns.length; d > c; c++)
                                if (n[c]) {
                                    var r = l.oApi._fnGetCellData(l, q[e], c, "display");
                                    b.fnCellRender ? k = b.fnCellRender(r, c, i, q[e]) + "" : "string" == typeof r ? (k = r.replace(/\n/g, " "), k = k.replace(/<img.*?\s+alt\s*=\s*(?:"([^"]+)"|'([^']+)'|([^\s>]+)).*?>/gi, "$1$2$3"), k = k.replace(/<.*?>/g, "")) : k = r + "", k = k.replace(/^\s+/, "").replace(/\s+$/, ""), k = this._fnHtmlDecode(k), g.push(this._fnBoundData(k, b.sFieldBoundary, m))
                        ...
                        var s = j.join(this._fnNewline(b));
                        return s
                    },
                    ...
                    "copy": a.extend({}, TableTools.buttonBase, {
                        ...
                        "fnComplete": function(a, b, c, d) {
                            var e = d.split("\n").length,
                                f = null === this.s.dt.nTFoot ? e - 1 : e - 2,
                                g = 1 == f ? "" : "s";
                            this.fnInfo("<h6>Table copied</h6><p>Copied " + f + " row" + g + " to the clipboard.</p>", 1500)
                        }
                    }),
                ...
                }, TableTools.defaults = TableTools.DEFAULTS, TableTools.prototype.CLASS = "TableTools", TableTools.version = "2.2.1", a.fn.dataTable.Api && a.fn.dataTable.Api.register("tabletools()", function() {
                    var a = null;
                    ...
                    "fnInit": function(a) {
                        var b = a.oInit,
                            ...
                            d = new TableTools(a.oInstance, c);
                        return TableTools._aInstances.push(d), d.dom.container
                    },
                    "cFeature": "T",
                    "sFeature": "TableTools"
    ...
    "function" == typeof define && define.amd ? define("datatables-tabletools", ["jquery", "datatables"], d) : jQuery && !jQuery.fn.dataTable.TableTools && d(jQuery, jQuery.fn.dataTable)
}(window, document);