 ...
 *         &lt;element name="mailFlow" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "CreateNewDeclaration")
public class CreateNewDeclaration {
    ...
    @XmlElementRef(name = "mailFlow", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> mailFlow;
     ...
     *     
     */
    public JAXBElement<String> getMailFlow() {
        return mailFlow;
    }
     ...
     *     
     */
    public void setMailFlow(JAXBElement<String> value) {
        this.mailFlow = value;
    }
