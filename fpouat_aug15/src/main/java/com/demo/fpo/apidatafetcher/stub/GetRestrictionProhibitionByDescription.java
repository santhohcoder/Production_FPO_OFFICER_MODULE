...
@XmlRootElement(name = "GetRestrictionProhibitionByDescription")
public class GetRestrictionProhibitionByDescription {
    ...
    @XmlElementRef(name = "goodDescription", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
