...
@Entity
@Table(name = "FPO_AC_CMTS")
public class FPO_AC_CMTS {
	
	
	@Id
	@GenericGenerator(name = "AC_CMTS_SEQ", strategy = "com.seq.gen.AC_CMTS_SEQIdGenerator")
	@GeneratedValue(generator = "AC_CMTS_SEQ")
	@Column(name = "ID")
	public Long id;
