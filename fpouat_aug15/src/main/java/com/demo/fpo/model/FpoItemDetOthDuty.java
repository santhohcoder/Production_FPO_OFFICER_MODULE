...
public class FpoItemDetOthDuty {
	...
	@Id
	@GenericGenerator(name = "OTHER_ITEM_UNIQUE_SEQ", strategy = "com.seq.gen.OTHER_ITEM_UNIQUE_SEQIdGenerator")
	@GeneratedValue(generator = "OTHER_ITEM_UNIQUE_SEQ")
	@Column(name = "ID")
	public Long id;
	...
	@Transient
	private Float totAllAmount;

	@Transient
	private Float totAllAmountFg;

	@Transient
	private Float allItemAmount;

	@Transient
	private Float allItemAmountFg;
	...
	public void setTotAllAmount(Float totAllAmount) {
		this.totAllAmount = totAllAmount;
	}

	public Float getTotAllAmountFg() {
		return totAllAmountFg;
	}

	public void setTotAllAmountFg(Float totAllAmountFg) {
		this.totAllAmountFg = totAllAmountFg;
	}

	public Float getAllItemAmount() {
		return allItemAmount;
	}

	public void setAllItemAmount(Float allItemAmount) {
		this.allItemAmount = allItemAmount;
	}

	public Float getAllItemAmountFg() {
		return allItemAmountFg;
	}

	public void setAllItemAmountFg(Float allItemAmountFg) {
		this.allItemAmountFg = allItemAmountFg;
	}
