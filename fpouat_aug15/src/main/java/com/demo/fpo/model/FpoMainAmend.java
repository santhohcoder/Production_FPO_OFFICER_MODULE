...
@Entity
@Table(name = "FPO_AMEND_MAIN")
public class FpoMainAmend {
	
	@Id
	@GenericGenerator(name = "AMEND_MAIN_SEQ", strategy = "com.seq.gen.FPOMAIN_NOIdGenerator")
	@GeneratedValue(generator = "AMEND_MAIN_SEQ")
