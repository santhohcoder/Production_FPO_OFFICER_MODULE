...
@Entity
public class MisOOEReceptacleProcess {
...
//	private String RECD_EVENT_DT;
	...
	/*
	 * public String getRECD_EVENT_DT() { return RECD_EVENT_DT; } public void
	 * setRECD_EVENT_DT(String rECD_EVENT_DT) { RECD_EVENT_DT = rECD_EVENT_DT; }
	 */
