...
@Service
public class DelistatDataserve {
	@Autowired
	...
	public PostDataServe fetArrPostData() {
		...
		String qry = "select arr_token as arrToken,delistat_endpoint as arrEndpoint,delistat_dataendpoint as arrDataEndpoint from post_dataserv_info";
