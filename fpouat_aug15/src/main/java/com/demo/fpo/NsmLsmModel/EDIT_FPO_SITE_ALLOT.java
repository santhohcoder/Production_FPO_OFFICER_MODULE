...
@Entity
@Table(name = "OPS$DIR.EDIT_FPO_SITE_ALLOT")
public class EDIT_FPO_SITE_ALLOT {
	
	@Id
	@GenericGenerator(name = "EDIT_FPO_SITE_ALLOT", strategy = "com.seq.gen.Fpo_allotSite_seq")
	@GeneratedValue(generator = "EDIT_FPO_SITE_ALLOT")
	@Column(name = "ID")
	public Long id;
